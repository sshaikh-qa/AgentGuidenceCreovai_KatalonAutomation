...
TEST_STEP="ENTER WORKFLOW NAME"
String workflowName = "Workflow_" + System.currentTimeMillis()
GlobalVariable.workflowNameGlobal = workflowName
CustomKeywords.'workflowKeywords.WorkflowsKeys.enterTextNameField'(GlobalVariable.workflowNameGlobal)

TEST_STEP= "CLICK ON THE ADD BUTTON"
CustomKeywords.'commonKeywords.CommonKeys.clickOnButton_Add_AddCancel_dynamic_btn'('Add')

TEST_STEP= "VERIFY THE WORKFLOW ADDED MATCHES WITH THE WORKFLOW HEADING AND WORKFLOW NAME IN LEFT PANE"
CustomKeywords.'workflowKeywords.WorkflowsKeys.verifyWorkflowAddedSuccessfully'(GlobalVariable.workflowNameGlobal)
