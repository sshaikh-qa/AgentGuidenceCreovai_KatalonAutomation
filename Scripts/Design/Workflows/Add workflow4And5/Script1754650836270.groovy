...
WebUI.comment('Add workflow 4 and 5')
...
TEST_STEP="ENTER 'Workflow test ' WITH A TRAILING SPACE"
String textTrailing = "Workflow test   " 
CustomKeywords.'workflowKeywords.WorkflowsKeys.enterTextNameField'(textTrailing)
...
CustomKeywords.'workflowKeywords.WorkflowsKeys.verifyAddWorkflowNameTooltipMessage'('This field cannot start or end with a space')

TEST_STEP="ENTER ' Workflow test' WITH A LEADING SPACE"
String textLeading = "  Workflow test"
CustomKeywords.'workflowKeywords.WorkflowsKeys.enterTextNameField'(textLeading)
