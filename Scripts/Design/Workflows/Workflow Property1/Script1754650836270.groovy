...
WebUI.comment('Workflow property -1')
...
TEST_STEP= "EDIT THE WORKFLOW NAME AND KEEP IT BLANK"
CustomKeywords.'workflowKeywords.WorkflowsKeys.enterworkflowName'('')

TEST_STEP= "VERIFY THE WORKFLOW NAME TEXTBOX IS BLANK"
...
CustomKeywords.'workflowKeywords.WorkflowsKeys.verifyWorkflowNameTooltipMessage'('This field is required')
